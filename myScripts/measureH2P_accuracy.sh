...
OUTPUT_FOLDER=/home/users/avontz/ChampSim/results/H2P/myTraces/H2P_AccuracyPerBranch
...
task(){	
	...
	(./bin/${EXECUTABLE} -warmup_instructions ${N_WARM} -simulation_instructions ${N_SIM} -perfect_H2P_file=${H2P_LOG_DIR}/${TRACE}.txt ${OPTION} -traces ${TRACE_DIR}/${TRACE}) &>  ${OUTPUT_FOLDER}/${TRACE}.txt
}
